    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Agencies Add</h3>
            </div>
        </div>
    </div> <!-- Row end -->

    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('agencies.store') }}">
            @csrf
            <div class="col-lg-12">
                <div class="card mb-3 p-3">
                    <div class="card-header py-3 p-0 d-flex justify-content-between bg-transparent border-bottom-0">
                        <h6 class="mb-0 fw-bold">Agencies Information</h6>
                    </div>
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="material" name="material" class="form-control"></textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="principals_logo">Agencies Logo</label>
                            <input type="file" id="principals_logo" name="principals_logo" class="form-control">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="flag_logo">Agencies Flag Logo</label>
                            <input type="file" id="flag_logo" name="flag_logo" class="form-control">
                        </div>
...
<script>
    ...
    function previewImages() {
        ...
        var files = document.getElementById('multiple_images').files;
