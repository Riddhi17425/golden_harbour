...
@section('title', 'Edit Industry Product')
    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Edit Industry Product</h3>
            </div>
        </div>
    </div>

    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('industryproduct.update', $data->id) }}">
            @csrf
            @method('PUT')
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <input type="file" id="input-file-front" name="image" class="dropify"
                                            data-default-file="{{ asset('public/product_industry_image/' . $data->image) }}">
                                    </div>
                                    @if ($errors->has('image'))
