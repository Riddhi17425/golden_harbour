    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Event Add</h3>
            </div>
        </div>
    </div> <!-- Row end -->
            ...
            <div class="col-lg-12">
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="home_image">Home Image</label>
                        ...
                        <div class="col-md-12">
                            <label class="form-label" for="cat_file"> Image</label>
                            <input type="file" id="multiple_images" name="multiple_images[]" multiple class="form-control" accept="image/*" onchange="previewImages()">
                        </div>
