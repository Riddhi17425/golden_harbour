            ...
            <div class="h-right d-flex align-items-center order-1">
                ...
                <div class="dropdown user-profile ms-3 d-flex align-items-center zindex-popover">
                    ...
                    <a class="nav-link dropdown-toggle pulse p-0" href="#" role="button" data-bs-toggle="dropdown"
                        ...
                        <img class="avatar lg rounded-circle img-thumbnail" src="{!! asset('public/admin_public/dist/assets/images/goldenharbour-logo.png') !!}"
                            alt="profile">
                            ...
                            <div class="card-body pb-0">
                                <div class="d-flex py-1">
                                    <img class="avatar rounded-circle"
                                        src="{!! asset('public/admin_public/dist/assets/images/goldenharbour-logo.png') !!}"
                                        alt="profile">
