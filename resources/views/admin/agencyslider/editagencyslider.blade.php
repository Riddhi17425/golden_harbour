...
@section('title', 'Agency Slider Edit')
    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Slider Edit</h3>
            </div>
        </div>
    </div> <!-- Row end  -->
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('agencyslider.update', $data->id) }}">
            @csrf
            @method('PUT')
                ...
                <div class="col-lg-12">
                    <div class="card mb-3">
                        <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                            <h6 class="mb-0 fw-bold ">Slider Details</h6>
                        </div>
                        <div class="card-body">
                            <div class="row g-3 align-items-center">
                                ...
                                <div class="card mb-3">
                                    <div
                                        ...
                                        <h6 class="mb-0 fw-bold">slider Image</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="row g-3 align-items-center">
                                            <div class="col-md-12">
                                                <label class="form-label" for="input-file-front"> Image Upload</label>
                                                <input type="file" id="input-file-front" name="slider_image"
                                                    class="dropify"
                                                    data-default-file="{{ asset('public/homeslider/' . $data->slider_image) }}">
                                            </div>
