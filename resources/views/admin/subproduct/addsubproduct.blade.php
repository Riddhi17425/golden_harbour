    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Sub Product Add</h3>
            </div>
        </div>
    </div> <!-- Row end -->

    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('subproduct.store') }}">
            @csrf
            <div class="col-lg-12">
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="industry_title_1" name="industry_title_1" class="form-control">
                        </div>
                        <div class="col-md-12">
                            <label for="industry_description_1" class="form-label">Industry1 Description</label>
                            <textarea id="industry_description_1" name="industry_description_1" class="form-control" ></textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="image">Industry1 Image</label>
                            <input type="file" id="industry_image_1" name="industry_image_1" class="form-control">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Industry2 Title</label>
                            <input type="text" id="industry_title_2" name="industry_title_2" class="form-control">
                        </div>
                        <div class="col-md-12">
                            <label for="industry_description_2" class="form-label">Industry2 Description</label>
                            <textarea id="industry_description_2" name="industry_description_2" class="form-control" ></textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="image">Industry2 Image</label>
                            <input type="file" id="industry_image_2" name="industry_image_2" class="form-control">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Industry3 Title</label>
                            <input type="text" id="industry_title_3" name="industry_title_3" class="form-control">
                        </div>
                        <div class="col-md-12">
                            <label for="industry_description_3" class="form-label">Industry3 Description</label>
                            <textarea id="industry_description_3" name="industry_description_3" class="form-control" ></textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="image">Industry3 Image</label>
                            <input type="file" id="industry_image_3" name="industry_image_3" class="form-control">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Industry4 Title</label>
                            <input type="text" id="industry_title_4" name="industry_title_4" class="form-control">
                        </div>
                        <div class="col-md-12">
                            <label for="industry_description" class="form-label">Industry4 Description</label>
                            <textarea id="industry_description_4" name="industry_description_4" class="form-control" ></textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="image">Industry4 Image</label>
                            <input type="file" id="industry_image_4" name="industry_image_4" class="form-control">
                        </div>
                        <div class="col-md-12">
...
$(document).ready(function() {
    ...
    $('#product_description,#industry_description_1,#industry_description_2,#industry_description_3,#industry_description_4').summernote({
        placeholder: 'Enter here...',
        height: 300,
        toolbar: [
            ['style', ['style']],
...
<script>
    ...
    if (subcategoryId) {
        $.ajax({
            url: '/admin/product/by-subcategory/' + subcategoryId,
            type: 'GET',
            dataType: 'json',
            success: function(data) {
