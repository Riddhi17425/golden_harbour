    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Video Add</h3>
            </div>
        </div>
    </div> <!-- Row end -->
                ...
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-12">
                           ...
                           <select class="form-select" name="file_type" aria-label="Default select example" required>
...
$(document).ready(function() {
    $('select[name="file_type"]').change(function() {
        ...
        if (fileType == "videolink") {
            $('#video_link_div').show(); 
            $('#video_upload_div').hide(); 
        }
        else if (fileType == "videoupload") {
