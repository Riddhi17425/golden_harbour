    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Edit Catalogue</h3>
            </div>
        </div>
    </div>

    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('catalog.update', $data->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="col-xl-12 col-lg-8">
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <input type="file" id="input-file-front" name="image" class="dropify"
                                            data-default-file="{{ asset('public/catalog_images/' . $data->image) }}">
                                    </div>
                                    @if ($errors->has('image'))
                        ...
                        @if ($data->pdf)
                            <div class="mt-2">
                                <a href="{{ asset('public/catalog_pdfs/' . $data->pdf) }}" target="_blank">View Current PDF</a>
                            </div>
                        @endif
