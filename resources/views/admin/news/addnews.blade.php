    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">News Add</h3>
            </div>
        </div>
    </div> <!-- Row end -->
            ...
            <div class="col-xl-12 col-lg-8">
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-12">
                            <label class="form-label" for="image">News CTA Text</label>
                            <textarea id="cta_image_text" name="cta_image_text" class="form-control"></textarea>
                        </div>
                        <div class="col-md-12">
