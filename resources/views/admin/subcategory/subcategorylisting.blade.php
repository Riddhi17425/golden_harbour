    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Sub Category</h3>
                ...
                <div class="card-body d-flex align-items-center flex-column flex-md-row">
                    <div class="ms-md-4 m-0 mt-4 mt-md-0 text-md-start text-center w-100">
                        <h6 class="mb-3 fw-bold">
                            {{ $subcategory->name }}
                            <span class="text-muted small fw-light d-block">{{ $subcategory->category->name }}</span>
                        </h6>
                        ...
                        <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2 d-inline-flex d-md-none">
                            ...
                            <form action="{{ route('subcategory.destroy', ['subcategory' => $subcategory->id]) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="ms-auto d-none d-md-flex">
                        <a href="{{ route('subcategory.edit', ['subcategory' => $subcategory->id]) }}" class="btn btn-warning me-2">Edit</a>
