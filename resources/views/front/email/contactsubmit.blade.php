            ...
            <tr class="text-center">
                <td style="padding: 37px 48px 58px 48px; font-family: 'Rubik', sans-serif; color: #333333;">
                    ...
                    <p style=" font-size: 14px; line-height: 20px;">
                        Thank you for reaching out to us. We’ve received your enquiry and one of our team members will get back to you shortly with the information you need.
                    </p>
                    <p style=" font-size: 14px; line-height: 20px;">
                        We appreciate your interest in Flexible Expansion Joint and look forward to assisting you.
                    </p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="background-color: #C12729; text-align: center; padding:8px;">
                    <p style=" font-size:12px; color:#FFFFFF; font-family:'Rubik', sans-serif; margin: 0;">
                        © 2025  2025 Al Mufaddal Engineering & Marine Services Co. LLC. All Rights Reserved.
                    </p>
                </td>
            </tr>
        </table>
