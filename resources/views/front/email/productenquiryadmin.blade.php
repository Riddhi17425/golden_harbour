        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:600px; margin:0 auto;">
            ...
            <tr class="text-center">
                <td style="padding: 37px 48px 37px 48px; font-family: 'Rubik', sans-serif; color: #333333;">
                    ...
                    <tbody>
                        <tr>
                            <td style="border: 1px solid #DDD;padding:9px 8px 8px 23px;">Full Name:</td>
                        ...
                        <tr>
                            <td style="border: 1px solid #DDD;padding:9px 8px 8px 23px;">Product Title:</td>
                            <td style="border: 1px solid #DDD;padding:9px 8px 8px 23px;">{{ $data->product_title }}</td>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #DDD;padding:9px 8px 8px 23px;">Category:</td>
                            <td style="border: 1px solid #DDD;padding:9px 8px 8px 23px;">{{ $data->product_category }}</td>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #DDD;padding:9px 8px 8px 23px;">Subcategory:</td>
                            <td style="border: 1px solid #DDD;padding:9px 8px 8px 23px;">{{ $data->product_subcategory }}</td>
                        </tr>
